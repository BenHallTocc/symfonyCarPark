...
use Ben\MyCarParkBundle\Entity\Vehicle;
use Ben\MyCarParkBundle\Form\VehicleType;
...
class VehicleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BenMyCarParkBundle:Vehicle')->findAll();
     ...
     * @Method("POST")
     * @Template("BenMyCarParkBundle:Vehicle:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BenMyCarParkBundle:Vehicle')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BenMyCarParkBundle:Vehicle:edit.html.twig")
     */
